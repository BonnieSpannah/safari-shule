...
/**
 * Thin styling wrapper around @radix-ui/react-dialog. Exports the primitives
 * so callers can compose freely, plus a pre-styled `<DialogContent>` /
 * `<DialogHeader>` / `<DialogFooter>` set. Used for confirm modals, edit
 * dialogs, previews, etc.
 */
