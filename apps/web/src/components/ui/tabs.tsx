...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-start gap-1 rounded-lg border border-border bg-surface-2/50 p-1 text-muted-foreground',
      className,
    )}
    {...props}
  />
